import { DEFAULT_MODEL_BY_PROVIDER, MODEL_OPTIONS_BY_PROVIDER, MODEL_SLUG_ALIASES_BY_PROVIDER, } from "@t3tools/contracts";
...
export function inferProviderForModel(model, fallback = "codex") {
    ...
    if (typeof model === "string") {
        ...
        if (trimmed.startsWith("gemini-"))
            return "gemini";
        if (trimmed.startsWith("opencode/") || trimmed.startsWith("anthropic/"))
            return "opencode";
    }
    return fallback;
}
