...
const TerminalIdWithDefaultSchema = TerminalIdSchema.pipe(Schema.withDecodingDefault(Effect.succeed(DEFAULT_TERMINAL_ID)));
...
export class TerminalCwdError extends Schema.TaggedErrorClass()("TerminalCwdError", {
    ...
    get message() {
        ...
        const causeMessage = this.cause && typeof this.cause === "object" && "message" in this.cause
            ? this.cause.message
            : undefined;
        return causeMessage
