...
import { ClaudeModelOptions, CodexModelOptions, GeminiModelOptions, OpencodeModelOptions, DEFAULT_GIT_TEXT_GENERATION_MODEL_BY_PROVIDER, } from "./model";
...
export const ClientSettingsSchema = Schema.Struct({
    ...
    sidebarProjectSortOrder: SidebarProjectSortOrder.pipe(Schema.withDecodingDefault(() => DEFAULT_SIDEBAR_PROJECT_SORT_ORDER)),
    sidebarThreadSortOrder: SidebarThreadSortOrder.pipe(Schema.withDecodingDefault(() => DEFAULT_SIDEBAR_THREAD_SORT_ORDER)),
...
export const ServerSettings = Schema.Struct({
    ...
    textGenerationModelSelection: ModelSelection.pipe(Schema.withDecodingDefault(() => ({
        provider: "gemini",
