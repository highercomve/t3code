...
import { ClaudeModelOptions, CodexModelOptions, CopilotModelOptions, GeminiModelOptions, OpencodeModelOptions, } from "./model";
...
export const OrchestrationThread = Schema.Struct({
    ...
    interactionMode: ProviderInteractionMode.pipe(Schema.withDecodingDefault(Effect.succeed(DEFAULT_PROVIDER_INTERACTION_MODE))),
