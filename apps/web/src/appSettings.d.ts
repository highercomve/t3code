...
export declare const AppSettingsSchema: Schema.Struct<{
  readonly claudeBinaryPath: Schema.withDecodingDefault<
    Schema.withConstructorDefault<Schema.String>
  >;
  readonly codexBinaryPath: Schema.withDecodingDefault<
    Schema.withConstructorDefault<Schema.String>
  >;
  ...
  >;
  readonly confirmThreadDelete: Schema.withDecodingDefault<
    Schema.withConstructorDefault<Schema.Boolean>
  >;
  readonly diffWordWrap: Schema.withDecodingDefault<Schema.withConstructorDefault<Schema.Boolean>>;
  readonly enableAssistantStreaming: Schema.withDecodingDefault<
    Schema.withConstructorDefault<Schema.Boolean>
  >;
  readonly timestampFormat: Schema.withDecodingDefault<
    Schema.withConstructorDefault<Schema.Literals<readonly ["locale", "12-hour", "24-hour"]>>
  >;
  readonly customCodexModels: Schema.withDecodingDefault<
    Schema.withConstructorDefault<Schema.$Array<Schema.String>>
  >;
  readonly customClaudeModels: Schema.withDecodingDefault<
    Schema.withConstructorDefault<Schema.$Array<Schema.String>>
  >;
  readonly customGeminiModels: Schema.withDecodingDefault<
    Schema.withConstructorDefault<Schema.$Array<Schema.String>>
  >;
...
export declare function getCustomModelsForProvider(
  settings: Pick<AppSettings, CustomModelSettingsKey>,
  provider: ProviderKind,
): readonly string[];
export declare function getDefaultCustomModelsForProvider(
  defaults: Pick<AppSettings, CustomModelSettingsKey>,
  provider: ProviderKind,
): readonly string[];
export declare function patchCustomModels(
  provider: ProviderKind,
  models: string[],
): Partial<Pick<AppSettings, CustomModelSettingsKey>>;
export declare function getCustomModelsByProvider(
  settings: Pick<AppSettings, CustomModelSettingsKey>,
