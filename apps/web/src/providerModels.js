...
export function normalizeClaudeModelOptionsWithCapabilities(caps, modelOptions) {
    ...
    const thinking = caps.supportsThinkingToggle && modelOptions?.thinking === false ? false : undefined;
...
export function normalizeGeminiModelOptionsWithCapabilities(caps, modelOptions) {
    const thinkingBudget = typeof modelOptions?.thinkingBudget === "number" &&
