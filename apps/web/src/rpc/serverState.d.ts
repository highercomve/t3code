import { type EditorId, type ServerConfig, type ServerConfigStreamEvent, type ServerConfigUpdatedPayload, type ServerLifecycleWelcomePayload, type ServerProvider, type ServerProviderUpdatedPayload, type ServerSettings } from "@t3tools/contracts";
...
export declare const serverConfigUpdatedAtom: Atom.Writable<ServerConfigUpdatedNotification | null, ServerConfigUpdatedNotification | null>;
...
export declare function onWelcome(listener: (payload: ServerLifecycleWelcomePayload) => void): () => void;
export declare function onServerConfigUpdated(listener: (payload: ServerConfigUpdatedPayload, source: ServerConfigUpdateSource) => void): () => void;
export declare function onProvidersUpdated(listener: (payload: ServerProviderUpdatedPayload) => void): () => void;
...
export declare function useServerWelcomeSubscription(listener: (payload: ServerLifecycleWelcomePayload) => void): void;
export declare function useServerConfigUpdatedSubscription(listener: (notification: ServerConfigUpdatedNotification) => void): void;
export {};
