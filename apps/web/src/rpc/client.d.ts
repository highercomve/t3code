...
declare const WsRpcAtomClient_base: AtomRpc.AtomRpcClient<
  WsRpcAtomClient,
  "WsRpcAtomClient",
  | import("effect/unstable/rpc/Rpc").Rpc<
      "server.getConfig",
      import("effect/Schema").Struct<{}>,
      import("effect/Schema").Struct<{
        readonly cwd: import("effect/Schema").Trim;
        readonly keybindingsConfigPath: import("effect/Schema").Trim;
        readonly keybindings: import("effect/Schema").$Array<
          import("effect/Schema").Struct<{
            readonly command: import("effect/Schema").Union<
              readonly [
                import("effect/Schema").Literals<
                  readonly [
                    "terminal.toggle",
                    "terminal.split",
                    "terminal.new",
                ...
                >,
                import("effect/Schema").TemplateLiteral<
                  readonly [
                    import("effect/Schema").Literal<"script.">,
                    import("effect/Schema").String,
                    import("effect/Schema").Literal<".run">,
                  ]
                >,
              ]
            >;
            ...
            readonly whenAst: import("effect/Schema").optional<
              import("effect/Schema").Union<
                readonly [
                  import("effect/Schema").Struct<{
                  ...
                  import("effect/Schema").Struct<{
                    ...
                    readonly node: import("effect/Schema").suspend<
                      import("effect/Schema").Codec<
                        import("@t3tools/contracts").KeybindingWhenNode,
                        import("@t3tools/contracts").KeybindingWhenNode,
                        never,
                        never
                      >
                  ...
                  import("effect/Schema").Struct<{
                    ...
                    readonly left: import("effect/Schema").suspend<
                      import("effect/Schema").Codec<
                        import("@t3tools/contracts").KeybindingWhenNode,
                        import("@t3tools/contracts").KeybindingWhenNode,
                        never,
                      ...
                      >
                    >;
                    readonly right: import("effect/Schema").suspend<
                      import("effect/Schema").Codec<
                        import("@t3tools/contracts").KeybindingWhenNode,
                        import("@t3tools/contracts").KeybindingWhenNode,
                        never,
        ...
        >;
        readonly issues: import("effect/Schema").$Array<
          import("effect/Schema").Union<
            readonly [
              import("effect/Schema").Struct<{
          ...
          >
        >;
        readonly providers: import("effect/Schema").$Array<
          import("effect/Schema").Struct<{
            readonly provider: import("effect/Schema").Literals<
              readonly ["codex", "gemini", "claudeAgent", "opencode", "copilotAgent"]
            >;
            ...
            readonly status: import("effect/Schema").Literals<
              readonly ["ready", "warning", "error", "disabled"]
            >;
            readonly auth: import("effect/Schema").Struct<{
              readonly status: import("effect/Schema").Literals<
                readonly ["authenticated", "unauthenticated", "unknown"]
              >;
            ...
            readonly models: import("effect/Schema").$Array<
              import("effect/Schema").Struct<{
                ...
                readonly capabilities: import("effect/Schema").NullOr<
                  import("effect/Schema").Struct<{
                    readonly reasoningEffortLevels: import("effect/Schema").$Array<
                      import("effect/Schema").Struct<{
                        readonly value: import("effect/Schema").Trim;
                        readonly label: import("effect/Schema").Trim;
                        readonly isDefault: import("effect/Schema").optional<
                          import("effect/Schema").Boolean
                        >;
                      }>
                    >;
                    readonly supportsFastMode: import("effect/Schema").Boolean;
                    readonly supportsThinkingToggle: import("effect/Schema").Boolean;
                    readonly contextWindowOptions: import("effect/Schema").$Array<
                      import("effect/Schema").Struct<{
                        readonly value: import("effect/Schema").Trim;
                        readonly label: import("effect/Schema").Trim;
                        readonly isDefault: import("effect/Schema").optional<
                    ...
                    >;
                    readonly promptInjectedEffortLevels: import("effect/Schema").$Array<
                      import("effect/Schema").Trim
                    >;
                  }>
                >;
              }>
            >;
            readonly dynamicModels: import("effect/Schema").optional<
              import("effect/Schema").$Array<
                import("effect/Schema").Struct<{
        ...
        >;
        readonly availableEditors: import("effect/Schema").$Array<
          import("effect/Schema").Literals<
            (
              | "cursor"
              | "trae"
        ...
        readonly settings: import("effect/Schema").Struct<{
          readonly enableAssistantStreaming: import("effect/Schema").withDecodingDefault<
            import("effect/Schema").Boolean
          >;
          readonly defaultThreadEnvMode: import("effect/Schema").withDecodingDefault<
            import("effect/Schema").Literals<readonly ["local", "worktree"]>
          >;
          readonly textGenerationModelSelection: import("effect/Schema").withDecodingDefault<
            import("effect/Schema").Union<
              readonly [
                import("effect/Schema").Struct<{
                  readonly provider: import("effect/Schema").Literal<"codex">;
                  readonly model: import("effect/Schema").Trim;
                  readonly options: import("effect/Schema").optionalKey<
                    import("effect/Schema").Struct<{
                      readonly reasoningEffort: import("effect/Schema").optional<
                        import("effect/Schema").Literals<
                          readonly ["xhigh", "high", "medium", "low"]
                        >
                      >;
                      readonly fastMode: import("effect/Schema").optional<
                        import("effect/Schema").Boolean
                      >;
                    }>
                  >;
                ...
                import("effect/Schema").Struct<{
                  ...
                  readonly options: import("effect/Schema").optionalKey<
                    import("effect/Schema").Struct<{
                      readonly thinkingBudget: import("effect/Schema").optional<
                        import("effect/Schema").Int
                      >;
                    }>
                  >;
                }>,
                import("effect/Schema").Struct<{
                  ...
                  readonly options: import("effect/Schema").optionalKey<
                    import("effect/Schema").Struct<{
                      readonly thinking: import("effect/Schema").optional<
                        import("effect/Schema").Boolean
                      >;
                      readonly effort: import("effect/Schema").optional<
                        import("effect/Schema").Literals<
                          readonly ["low", "medium", "high", "max", "ultrathink"]
                        >
                      >;
                      readonly fastMode: import("effect/Schema").optional<
                        import("effect/Schema").Boolean
                      >;
                      readonly contextWindow: import("effect/Schema").optional<
                        import("effect/Schema").String
                      >;
                    }>
                  >;
            ...
            >
          >;
          readonly providers: import("effect/Schema").withDecodingDefault<
            import("effect/Schema").Struct<{
              readonly codex: import("effect/Schema").withDecodingDefault<
                import("effect/Schema").Struct<{
                  readonly enabled: import("effect/Schema").withDecodingDefault<
                    import("effect/Schema").Boolean
                  >;
                  readonly binaryPath: import("effect/Schema").withDecodingDefault<
                    import("effect/Schema").decodeTo<
                      import("effect/Schema").String,
                      import("effect/Schema").Trim,
                      never,
                      never
                    >
                  >;
                  readonly homePath: import("effect/Schema").withDecodingDefault<
                    import("effect/Schema").Trim
                  >;
                  readonly customModels: import("effect/Schema").withDecodingDefault<
                    import("effect/Schema").$Array<import("effect/Schema").String>
                  >;
                }>
              >;
              readonly gemini: import("effect/Schema").withDecodingDefault<
                import("effect/Schema").Struct<{
                  readonly enabled: import("effect/Schema").withDecodingDefault<
                    import("effect/Schema").Boolean
                  >;
              ...
              >;
              readonly claudeAgent: import("effect/Schema").withDecodingDefault<
                import("effect/Schema").Struct<{
                  readonly enabled: import("effect/Schema").withDecodingDefault<
                    import("effect/Schema").Boolean
                  >;
              ...
              >;
              readonly opencode: import("effect/Schema").withDecodingDefault<
                import("effect/Schema").Struct<{
                  readonly enabled: import("effect/Schema").withDecodingDefault<
                    import("effect/Schema").Boolean
                  >;
                  readonly binaryPath: import("effect/Schema").withDecodingDefault<
                    ...
                    >
                  >;
                  readonly apiKey: import("effect/Schema").withDecodingDefault<
                    import("effect/Schema").Trim
                  >;
                  readonly customModels: import("effect/Schema").withDecodingDefault<
                    import("effect/Schema").$Array<import("effect/Schema").String>
              ...
              >;
              readonly copilotAgent: import("effect/Schema").withDecodingDefault<
                import("effect/Schema").Struct<{
                  readonly enabled: import("effect/Schema").withDecodingDefault<
                    import("effect/Schema").Boolean
                  >;
          ...
          >;
          readonly observability: import("effect/Schema").withDecodingDefault<
            import("effect/Schema").Struct<{
              readonly otlpTracesUrl: import("effect/Schema").withDecodingDefault<
                import("effect/Schema").Trim
              >;
              readonly otlpMetricsUrl: import("effect/Schema").withDecodingDefault<
                import("effect/Schema").Trim
              >;
            }>
          >;
      ...
      import("effect/Schema").Union<
        readonly [
          typeof import("@t3tools/contracts").KeybindingsConfigError,
          typeof import("@t3tools/contracts").ServerSettingsError,
        ]
      >,
      never,
      never
            ...
            readonly [
              import("effect/Schema").Struct<{
                ...
                readonly options: import("effect/Schema").optionalKey<
                  import("effect/Schema").Struct<{
                    readonly reasoningEffort: import("effect/Schema").optional<
                      import("effect/Schema").Literals<readonly ["xhigh", "high", "medium", "low"]>
                    >;
                    readonly fastMode: import("effect/Schema").optional<
                      import("effect/Schema").Boolean
                    >;
  ...
  | import("effect/unstable/rpc/Rpc").Rpc<
      ...
      import("effect/Schema").Struct<{
        readonly patch: import("effect/Schema").Struct<{
          readonly enableAssistantStreaming: import("effect/Schema").optionalKey<
            import("effect/Schema").Boolean
          >;
          readonly defaultThreadEnvMode: import("effect/Schema").optionalKey<
            import("effect/Schema").Literals<readonly ["local", "worktree"]>
          >;
          readonly textGenerationModelSelection: import("effect/Schema").optionalKey<
            import("effect/Schema").Union<
              readonly [
                import("effect/Schema").Struct<{
                  readonly provider: import("effect/Schema").optionalKey<
                    import("effect/Schema").Literal<"codex">
                  >;
                  readonly model: import("effect/Schema").optionalKey<import("effect/Schema").Trim>;
                  readonly options: import("effect/Schema").optionalKey<
                    import("effect/Schema").Struct<{
                      readonly reasoningEffort: import("effect/Schema").optionalKey<
                        import("effect/Schema").optional<
                          import("effect/Schema").Literals<
                            readonly ["xhigh", "high", "medium", "low"]
                          >
                        >
                      >;
                      readonly fastMode: import("effect/Schema").optionalKey<
                        import("effect/Schema").optional<import("effect/Schema").Boolean>
                      >;
                    }>
                  >;
                }>,
                import("effect/Schema").Struct<{
                  readonly provider: import("effect/Schema").optionalKey<
                    import("effect/Schema").Literal<"gemini">
                  >;
                  readonly model: import("effect/Schema").optionalKey<import("effect/Schema").Trim>;
                  readonly options: import("effect/Schema").optionalKey<
                    import("effect/Schema").Struct<{
                      readonly thinkingBudget: import("effect/Schema").optionalKey<
                        import("effect/Schema").optional<import("effect/Schema").Int>
                      >;
                    }>
                  >;
                }>,
                import("effect/Schema").Struct<{
                  readonly provider: import("effect/Schema").optionalKey<
                    import("effect/Schema").Literal<"claudeAgent">
                  >;
                  readonly model: import("effect/Schema").optionalKey<import("effect/Schema").Trim>;
                  readonly options: import("effect/Schema").optionalKey<
                    import("effect/Schema").Struct<{
                      readonly thinking: import("effect/Schema").optionalKey<
                        import("effect/Schema").optional<import("effect/Schema").Boolean>
                      >;
                      readonly effort: import("effect/Schema").optionalKey<
                        import("effect/Schema").optional<
                          import("effect/Schema").Literals<
                            readonly ["low", "medium", "high", "max", "ultrathink"]
                          >
                      ...
                      readonly fastMode: import("effect/Schema").optionalKey<
                        import("effect/Schema").optional<import("effect/Schema").Boolean>
                      >;
                      readonly contextWindow: import("effect/Schema").optionalKey<
                        import("effect/Schema").optional<import("effect/Schema").String>
                      >;
                    }>
                  >;
                }>,
                import("effect/Schema").Struct<{
                  readonly provider: import("effect/Schema").optionalKey<
                    import("effect/Schema").Literal<"opencode">
                  >;
                  readonly model: import("effect/Schema").optionalKey<import("effect/Schema").Trim>;
                  readonly options: import("effect/Schema").optionalKey<
                    import("effect/Schema").Struct<{
                ...
                import("effect/Schema").Struct<{
                  readonly provider: import("effect/Schema").optionalKey<
                    import("effect/Schema").Literal<"copilotAgent">
                  >;
                  readonly model: import("effect/Schema").optionalKey<import("effect/Schema").Trim>;
                  readonly options: import("effect/Schema").optionalKey<
                    import("effect/Schema").Struct<{
            ...
            >
          >;
          readonly observability: import("effect/Schema").optionalKey<
            import("effect/Schema").Struct<{
              readonly otlpTracesUrl: import("effect/Schema").optionalKey<
                import("effect/Schema").String
              >;
              readonly otlpMetricsUrl: import("effect/Schema").optionalKey<
                import("effect/Schema").String
              >;
            }>
          >;
          readonly providers: import("effect/Schema").optionalKey<
            import("effect/Schema").Struct<{
              readonly codex: import("effect/Schema").optionalKey<
                import("effect/Schema").Struct<{
                  readonly enabled: import("effect/Schema").optionalKey<
                    import("effect/Schema").Boolean
                  >;
                  readonly binaryPath: import("effect/Schema").optionalKey<
                    import("effect/Schema").String
                  >;
                  readonly homePath: import("effect/Schema").optionalKey<
                    import("effect/Schema").String
                  >;
                  readonly customModels: import("effect/Schema").optionalKey<
                    import("effect/Schema").$Array<import("effect/Schema").String>
                  >;
                }>
              >;
              readonly gemini: import("effect/Schema").optionalKey<
                import("effect/Schema").Struct<{
                  readonly enabled: import("effect/Schema").optionalKey<
                    import("effect/Schema").Boolean
                  >;
              ...
              >;
              readonly claudeAgent: import("effect/Schema").optionalKey<
                import("effect/Schema").Struct<{
                  readonly enabled: import("effect/Schema").optionalKey<
                    import("effect/Schema").Boolean
                  >;
              ...
              >;
              readonly opencode: import("effect/Schema").optionalKey<
                import("effect/Schema").Struct<{
                  readonly enabled: import("effect/Schema").optionalKey<
                    import("effect/Schema").Boolean
                  >;
                  readonly binaryPath: import("effect/Schema").optionalKey<
                    import("effect/Schema").String
                  >;
                  readonly apiKey: import("effect/Schema").optionalKey<
                    import("effect/Schema").String
                  >;
                  readonly customModels: import("effect/Schema").optionalKey<
                    import("effect/Schema").$Array<import("effect/Schema").String>
              ...
              >;
              readonly copilotAgent: import("effect/Schema").optionalKey<
                import("effect/Schema").Struct<{
                  readonly enabled: import("effect/Schema").optionalKey<
                    import("effect/Schema").Boolean
                  >;
  ...
  | import("effect/unstable/rpc/Rpc").Rpc<
      ...
      import("effect/Schema").Struct<{
        readonly entries: import("effect/Schema").$Array<
          import("effect/Schema").Struct<{
      ...
      typeof import("@t3tools/contracts").ProjectSearchEntriesError,
      never,
      never
    >
  | import("effect/unstable/rpc/Rpc").Rpc<
      ...
      typeof import("@t3tools/contracts").ProjectWriteFileError,
      never,
      never
    >
  | import("effect/unstable/rpc/Rpc").Rpc<
      ...
      import("effect/Schema").Struct<{
        readonly cwd: import("effect/Schema").Trim;
        readonly editor: import("effect/Schema").Literals<
          (
            | "cursor"
            | "trae"
            | "vscode"
      ...
      typeof import("@t3tools/contracts").OpenError,
      never,
      never
    >
  | import("effect/unstable/rpc/Rpc").Rpc<
      ...
      import("effect/Schema").Struct<{
        ...
        readonly workingTree: import("effect/Schema").Struct<{
          readonly files: import("effect/Schema").$Array<
            import("effect/Schema").Struct<{
              readonly path: import("effect/Schema").Trim;
        ...
        readonly pr: import("effect/Schema").NullOr<
          import("effect/Schema").Struct<{
      ...
      import("effect/Schema").Union<
        readonly [
          typeof import("@t3tools/contracts").GitManagerError,
          typeof import("@t3tools/contracts").GitCommandError,
          typeof import("@t3tools/contracts").GitHubCliError,
          typeof import("@t3tools/contracts").TextGenerationError,
        ]
      >,
      never,
      never
  ...
  | import("effect/unstable/rpc/Rpc").Rpc<
      ...
      import("effect/Schema").Struct<{
        readonly status: import("effect/Schema").Literals<
          readonly ["pulled", "skipped_up_to_date"]
        >;
  ...
  | import("effect/unstable/rpc/Rpc").Rpc<
      ...
      import("effect/Schema").Struct<{
        ...
        readonly cwd: import("effect/Schema").Trim;
        readonly action: import("effect/Schema").Literals<
          readonly ["commit", "push", "create_pr", "commit_push", "commit_push_pr"]
        >;
        ...
        readonly filePaths: import("effect/Schema").optional<
          import("effect/Schema").$Array<import("effect/Schema").Trim>
        >;
      }>,
      import("effect/unstable/rpc/RpcSchema").Stream<
        import("effect/Schema").Union<
          readonly [
            import("effect/Schema").Struct<{
              readonly kind: import("effect/Schema").Literal<"action_started">;
              readonly phases: import("effect/Schema").$Array<
                import("effect/Schema").Literals<readonly ["branch", "commit", "push", "pr"]>
              >;
              readonly actionId: import("effect/Schema").Trim;
              readonly cwd: import("effect/Schema").Trim;
              readonly action: import("effect/Schema").Literals<
            ...
            import("effect/Schema").Struct<{
              ...
              readonly phase: import("effect/Schema").Literals<
                readonly ["branch", "commit", "push", "pr"]
              >;
              readonly label: import("effect/Schema").Trim;
              readonly actionId: import("effect/Schema").Trim;
              readonly cwd: import("effect/Schema").Trim;
            ...
            import("effect/Schema").Struct<{
              ...
              readonly result: import("effect/Schema").Struct<{
                ...
                readonly branch: import("effect/Schema").Struct<{
                  readonly status: import("effect/Schema").Literals<
                    readonly ["created", "skipped_not_requested"]
                  >;
                  readonly name: import("effect/Schema").optional<import("effect/Schema").Trim>;
                }>;
                readonly commit: import("effect/Schema").Struct<{
                  readonly status: import("effect/Schema").Literals<
                    readonly ["created", "skipped_no_changes", "skipped_not_requested"]
                  >;
                  readonly commitSha: import("effect/Schema").optional<
                    import("effect/Schema").Trim
                  >;
                ...
                readonly push: import("effect/Schema").Struct<{
                  readonly status: import("effect/Schema").Literals<
                    readonly ["pushed", "skipped_not_requested", "skipped_up_to_date"]
                  >;
                  readonly branch: import("effect/Schema").optional<import("effect/Schema").Trim>;
                  readonly upstreamBranch: import("effect/Schema").optional<
                    import("effect/Schema").Trim
                  >;
                  readonly setUpstream: import("effect/Schema").optional<
                    import("effect/Schema").Boolean
                  >;
                }>;
                readonly pr: import("effect/Schema").Struct<{
                  readonly status: import("effect/Schema").Literals<
                    readonly ["created", "opened_existing", "skipped_not_requested"]
                  >;
                  ...
                  readonly baseBranch: import("effect/Schema").optional<
                    import("effect/Schema").Trim
                  >;
                  readonly headBranch: import("effect/Schema").optional<
                    import("effect/Schema").Trim
                  >;
                ...
                readonly toast: import("effect/Schema").Struct<{
                  readonly title: import("effect/Schema").Trim;
                  readonly description: import("effect/Schema").optional<
                    import("effect/Schema").Trim
                  >;
                  readonly cta: import("effect/Schema").Union<
                    readonly [
                      import("effect/Schema").Struct<{
                      ...
                      import("effect/Schema").Struct<{
                        ...
                        readonly action: import("effect/Schema").Struct<{
                          readonly kind: import("effect/Schema").Literals<
                            readonly [
                              "commit",
                              "push",
                              "create_pr",
            ...
            import("effect/Schema").Struct<{
              ...
              readonly phase: import("effect/Schema").NullOr<
                import("effect/Schema").Literals<readonly ["branch", "commit", "push", "pr"]>
              >;
              readonly message: import("effect/Schema").Trim;
              readonly actionId: import("effect/Schema").Trim;
  ...
  | import("effect/unstable/rpc/Rpc").Rpc<
      ...
      import("effect/Schema").Struct<{
        ...
        readonly threadId: import("effect/Schema").optional<
          import("effect/Schema").brand<import("effect/Schema").Trim, "ThreadId">
        >;
      }>,
      import("effect/Schema").Struct<{
        readonly pullRequest: import("effect/Schema").Struct<{
  ...
  | import("effect/unstable/rpc/Rpc").Rpc<
      ...
      import("effect/Schema").Struct<{
        readonly branches: import("effect/Schema").$Array<
          import("effect/Schema").Struct<{
            readonly name: import("effect/Schema").Trim;
  ...
  | import("effect/unstable/rpc/Rpc").Rpc<
      ...
      import("effect/Schema").Struct<{
        readonly cwd: import("effect/Schema").Trim;
        readonly worktreePath: import("effect/Schema").optional<
          import("effect/Schema").NullOr<import("effect/Schema").Trim>
        >;
        ...
        readonly env: import("effect/Schema").optional<
          import("effect/Schema").$Record<
            import("effect/Schema").String,
            import("effect/Schema").String
          >
        >;
        readonly terminalId: import("effect/Schema").withDecodingDefault<
          import("effect/Schema").Trim
        >;
      ...
      import("effect/Schema").Struct<{
        ...
        readonly worktreePath: import("effect/Schema").NullOr<import("effect/Schema").Trim>;
        readonly status: import("effect/Schema").Literals<
          readonly ["starting", "running", "exited", "error"]
        >;
      ...
      import("effect/Schema").Union<
        readonly [
          typeof import("@t3tools/contracts").TerminalCwdError,
          typeof import("@t3tools/contracts").TerminalHistoryError,
          typeof import("@t3tools/contracts").TerminalSessionLookupError,
          typeof import("@t3tools/contracts").TerminalNotRunningError,
        ]
      >,
      never,
      never
          ...
          readonly [
            import("effect/Schema").Struct<{
              ...
              readonly payload: import("effect/Schema").Struct<{
                readonly projectId: import("effect/Schema").brand<
                  import("effect/Schema").Trim,
                  "ProjectId"
                >;
                readonly title: import("effect/Schema").Trim;
                readonly workspaceRoot: import("effect/Schema").Trim;
                readonly defaultModelSelection: import("effect/Schema").NullOr<
                  import("effect/Schema").Union<
                    readonly [
                      import("effect/Schema").Struct<{
                        readonly provider: import("effect/Schema").Literal<"codex">;
                  ...
                  >
                >;
                readonly scripts: import("effect/Schema").$Array<
                  import("effect/Schema").Struct<{
                    readonly id: import("effect/Schema").Trim;
                    readonly name: import("effect/Schema").Trim;
                    readonly command: import("effect/Schema").Trim;
                    readonly icon: import("effect/Schema").Literals<
                      readonly ["play", "test", "lint", "configure", "build", "debug"]
                    >;
              ...
              readonly eventId: import("effect/Schema").brand<
                import("effect/Schema").Trim,
                "EventId"
              >;
              readonly aggregateKind: import("effect/Schema").Literals<
                readonly ["project", "thread"]
              >;
              readonly aggregateId: import("effect/Schema").Union<
                readonly [
                  import("effect/Schema").brand<import("effect/Schema").Trim, "ProjectId">,
                  import("effect/Schema").brand<import("effect/Schema").Trim, "ThreadId">,
                ]
              >;
              readonly occurredAt: import("effect/Schema").String;
              readonly commandId: import("effect/Schema").NullOr<
                import("effect/Schema").brand<import("effect/Schema").Trim, "CommandId">
              >;
              readonly causationEventId: import("effect/Schema").NullOr<
                import("effect/Schema").brand<import("effect/Schema").Trim, "EventId">
              >;
              readonly correlationId: import("effect/Schema").NullOr<
                import("effect/Schema").brand<import("effect/Schema").Trim, "CommandId">
              >;
              readonly metadata: import("effect/Schema").Struct<{
                readonly providerTurnId: import("effect/Schema").optional<
                  import("effect/Schema").Trim
                >;
                readonly providerItemId: import("effect/Schema").optional<
                  import("effect/Schema").brand<import("effect/Schema").Trim, "ProviderItemId">
                >;
                readonly adapterKey: import("effect/Schema").optional<import("effect/Schema").Trim>;
                readonly requestId: import("effect/Schema").optional<
                  import("effect/Schema").brand<import("effect/Schema").Trim, "ApprovalRequestId">
                >;
                readonly ingestedAt: import("effect/Schema").optional<
                  import("effect/Schema").String
                >;
              }>;
            }>,
            import("effect/Schema").Struct<{
              ...
              readonly payload: import("effect/Schema").Struct<{
                ...
                >;
                readonly title: import("effect/Schema").optional<import("effect/Schema").Trim>;
                readonly workspaceRoot: import("effect/Schema").optional<
                  import("effect/Schema").Trim
                >;
                readonly defaultModelSelection: import("effect/Schema").optional<
                  import("effect/Schema").NullOr<
                    import("effect/Schema").Union<
                      readonly [
                        import("effect/Schema").Struct<{
                          readonly provider: import("effect/Schema").Literal<"codex">;
                  ...
                  >
                >;
                readonly scripts: import("effect/Schema").optional<
                  import("effect/Schema").$Array<
                    import("effect/Schema").Struct<{
                      readonly id: import("effect/Schema").Trim;
                      readonly name: import("effect/Schema").Trim;
            ...
            import("effect/Schema").Struct<{
              ...
              readonly payload: import("effect/Schema").Struct<{
                readonly threadId: import("effect/Schema").brand<
                  import("effect/Schema").Trim,
                  "ThreadId"
                >;
                readonly projectId: import("effect/Schema").brand<
                ...
                >;
                readonly title: import("effect/Schema").Trim;
                readonly modelSelection: import("effect/Schema").Union<
                  readonly [
                    import("effect/Schema").Struct<{
                      readonly provider: import("effect/Schema").Literal<"codex">;
                      readonly model: import("effect/Schema").Trim;
                ...
                >;
                readonly runtimeMode: import("effect/Schema").withDecodingDefault<
                  import("effect/Schema").Literals<readonly ["approval-required", "full-access"]>
                >;
                readonly interactionMode: import("effect/Schema").withDecodingDefault<
                  import("effect/Schema").Literals<readonly ["default", "plan"]>
                >;
                readonly branch: import("effect/Schema").NullOr<import("effect/Schema").Trim>;
                readonly worktreePath: import("effect/Schema").NullOr<import("effect/Schema").Trim>;
                readonly createdAt: import("effect/Schema").String;
            ...
            import("effect/Schema").Struct<{
              ...
              readonly payload: import("effect/Schema").Struct<{
                ...
                >;
                readonly title: import("effect/Schema").optional<import("effect/Schema").Trim>;
                readonly modelSelection: import("effect/Schema").optional<
                  import("effect/Schema").Union<
                    readonly [
                      import("effect/Schema").Struct<{
                        readonly provider: import("effect/Schema").Literal<"codex">;
                  ...
                  >
                >;
                readonly branch: import("effect/Schema").optional<
                  import("effect/Schema").NullOr<import("effect/Schema").Trim>
                >;
                readonly worktreePath: import("effect/Schema").optional<
                  import("effect/Schema").NullOr<import("effect/Schema").Trim>
            ...
            import("effect/Schema").Struct<{
              ...
              readonly payload: import("effect/Schema").Struct<{
                readonly threadId: import("effect/Schema").brand<
                  ...
                  "ThreadId"
                >;
                readonly runtimeMode: import("effect/Schema").Literals<
                  readonly ["approval-required", "full-access"]
                >;
                readonly updatedAt: import("effect/Schema").String;
              }>;
              readonly sequence: import("effect/Schema").Int;
            ...
            import("effect/Schema").Struct<{
              ...
              readonly payload: import("effect/Schema").Struct<{
                readonly threadId: import("effect/Schema").brand<
                  ...
                  "ThreadId"
                >;
                readonly messageId: import("effect/Schema").brand<
                  import("effect/Schema").Trim,
                  "MessageId"
                >;
                readonly role: import("effect/Schema").Literals<
                  readonly ["user", "assistant", "system"]
                >;
                readonly text: import("effect/Schema").String;
                readonly attachments: import("effect/Schema").optional<
                  import("effect/Schema").$Array<
                    import("effect/Schema").Union<
                      readonly [
                        import("effect/Schema").Struct<{
                  ...
                  >
                >;
                readonly turnId: import("effect/Schema").NullOr<
                  import("effect/Schema").brand<import("effect/Schema").Trim, "TurnId">
                >;
            ...
            import("effect/Schema").Struct<{
              ...
              readonly payload: import("effect/Schema").Struct<{
                ...
                readonly modelSelection: import("effect/Schema").optional<
                  ...
                  >
                >;
                readonly providerOptions: import("effect/Schema").optional<
                  import("effect/Schema").Struct<{
                    readonly codex: import("effect/Schema").optional<
                      import("effect/Schema").Struct<{
                        readonly binaryPath: import("effect/Schema").optional<
                          import("effect/Schema").Trim
                        >;
                        readonly homePath: import("effect/Schema").optional<
                          import("effect/Schema").Trim
                        >;
                      }>
                    >;
                    readonly gemini: import("effect/Schema").optional<
                      import("effect/Schema").Struct<{
                        readonly binaryPath: import("effect/Schema").optional<
                          import("effect/Schema").Trim
                        >;
                    ...
                    >;
                    readonly claudeAgent: import("effect/Schema").optional<
                      import("effect/Schema").Struct<{
                        readonly binaryPath: import("effect/Schema").optional<
                          import("effect/Schema").Trim
                        >;
                        readonly permissionMode: import("effect/Schema").optional<
                          import("effect/Schema").Trim
                        >;
                        readonly maxThinkingTokens: import("effect/Schema").optional<
                          import("effect/Schema").Int
                        >;
                      }>
                    >;
                    readonly opencode: import("effect/Schema").optional<
                      import("effect/Schema").Struct<{
                        readonly binaryPath: import("effect/Schema").optional<
                          import("effect/Schema").Trim
                        >;
                        readonly apiKey: import("effect/Schema").optional<
                          import("effect/Schema").Trim
                        >;
                      }>
                    >;
                    readonly copilotAgent: import("effect/Schema").optional<
                      import("effect/Schema").Struct<{
                        readonly binaryPath: import("effect/Schema").optional<
                          import("effect/Schema").Trim
                        >;
                ...
                >;
                readonly assistantDeliveryMode: import("effect/Schema").optional<
                  import("effect/Schema").Literals<readonly ["buffered", "streaming"]>
                >;
                ...
                readonly interactionMode: import("effect/Schema").withDecodingDefault<
                  import("effect/Schema").Literals<readonly ["default", "plan"]>
                >;
                readonly sourceProposedPlan: import("effect/Schema").optional<
                  import("effect/Schema").Struct<{
                    readonly threadId: import("effect/Schema").brand<
                      import("effect/Schema").Trim,
                      "ThreadId"
            ...
            import("effect/Schema").Struct<{
              ...
              readonly payload: import("effect/Schema").Struct<{
                readonly threadId: import("effect/Schema").brand<
                  ...
                  "ThreadId"
                >;
                readonly turnId: import("effect/Schema").optional<
                  import("effect/Schema").brand<import("effect/Schema").Trim, "TurnId">
                >;
                readonly createdAt: import("effect/Schema").String;
              }>;
            ...
            import("effect/Schema").Struct<{
              ...
              readonly payload: import("effect/Schema").Struct<{
                readonly threadId: import("effect/Schema").brand<
                  ...
                  "ThreadId"
                >;
                readonly requestId: import("effect/Schema").brand<
                  import("effect/Schema").Trim,
                  "ApprovalRequestId"
                >;
                readonly decision: import("effect/Schema").Literals<
                  readonly ["accept", "acceptForSession", "decline", "cancel"]
                >;
                readonly createdAt: import("effect/Schema").String;
              }>;
              readonly sequence: import("effect/Schema").Int;
            ...
            import("effect/Schema").Struct<{
              ...
              readonly payload: import("effect/Schema").Struct<{
                ...
                readonly requestId: import("effect/Schema").brand<
                  ...
                  "ApprovalRequestId"
                >;
                readonly answers: import("effect/Schema").$Record<
                  import("effect/Schema").String,
                  import("effect/Schema").Unknown
                >;
                readonly createdAt: import("effect/Schema").String;
              }>;
              readonly sequence: import("effect/Schema").Int;
            ...
            import("effect/Schema").Struct<{
              ...
              readonly payload: import("effect/Schema").Struct<{
                ...
                readonly session: import("effect/Schema").Struct<{
                  ...
                  >;
                  readonly providerName: import("effect/Schema").NullOr<
                    import("effect/Schema").Trim
                  >;
                  readonly runtimeMode: import("effect/Schema").withDecodingDefault<
                    import("effect/Schema").Literals<readonly ["approval-required", "full-access"]>
                  >;
                  readonly activeTurnId: import("effect/Schema").NullOr<
                    import("effect/Schema").brand<import("effect/Schema").Trim, "TurnId">
                  >;
            ...
            import("effect/Schema").Struct<{
              ...
              readonly payload: import("effect/Schema").Struct<{
                ...
                readonly proposedPlan: import("effect/Schema").Struct<{
                  ...
                  readonly implementedAt: import("effect/Schema").withDecodingDefault<
                    import("effect/Schema").NullOr<import("effect/Schema").String>
                  >;
                  readonly implementationThreadId: import("effect/Schema").withDecodingDefault<
                    import("effect/Schema").NullOr<
                      import("effect/Schema").brand<import("effect/Schema").Trim, "ThreadId">
                    >
                  >;
            ...
            import("effect/Schema").Struct<{
              ...
              readonly payload: import("effect/Schema").Struct<{
                readonly threadId: import("effect/Schema").brand<
                  ...
                  "ThreadId"
                >;
                readonly turnId: import("effect/Schema").brand<
                  import("effect/Schema").Trim,
                  "TurnId"
                >;
                readonly checkpointTurnCount: import("effect/Schema").Int;
                readonly checkpointRef: import("effect/Schema").brand<
                  import("effect/Schema").Trim,
                  "CheckpointRef"
                >;
                readonly status: import("effect/Schema").Literals<
                  readonly ["ready", "missing", "error"]
                >;
                readonly files: import("effect/Schema").$Array<
                  import("effect/Schema").Struct<{
                    readonly path: import("effect/Schema").Trim;
                ...
                >;
                readonly assistantMessageId: import("effect/Schema").NullOr<
                  import("effect/Schema").brand<import("effect/Schema").Trim, "MessageId">
                >;
            ...
            import("effect/Schema").Struct<{
              ...
              readonly payload: import("effect/Schema").Struct<{
                ...
                readonly activity: import("effect/Schema").Struct<{
                  readonly id: import("effect/Schema").brand<
                    import("effect/Schema").Trim,
                    "EventId"
                  >;
                  readonly tone: import("effect/Schema").Literals<
                    readonly ["info", "tool", "approval", "error"]
                  >;
                  readonly kind: import("effect/Schema").Trim;
            ...
            import("effect/Schema").Struct<{
              ...
              readonly config: import("effect/Schema").Struct<{
                ...
                readonly providers: import("effect/Schema").$Array<
                  import("effect/Schema").Struct<{
                    ...
                    readonly auth: import("effect/Schema").Struct<{
                      ...
                      >;
                      readonly type: import("effect/Schema").optional<import("effect/Schema").Trim>;
                      readonly label: import("effect/Schema").optional<
                        import("effect/Schema").Trim
                      >;
                    }>;
                    readonly checkedAt: import("effect/Schema").String;
                    readonly message: import("effect/Schema").optional<
                      import("effect/Schema").Trim
                    >;
                    readonly models: import("effect/Schema").$Array<
                      import("effect/Schema").Struct<{
                ...
                readonly observability: import("effect/Schema").Struct<{
                  readonly logsDirectoryPath: import("effect/Schema").Trim;
                  readonly localTracingEnabled: import("effect/Schema").Boolean;
                  readonly otlpTracesUrl: import("effect/Schema").optional<
                    import("effect/Schema").Trim
                  >;
                  readonly otlpTracesEnabled: import("effect/Schema").Boolean;
                  readonly otlpMetricsUrl: import("effect/Schema").optional<
                    import("effect/Schema").Trim
                  >;
                  readonly otlpMetricsEnabled: import("effect/Schema").Boolean;
                }>;
          ...
          readonly [
            import("effect/Schema").Struct<{
              ...
              readonly payload: import("effect/Schema").Struct<{
                ...
                readonly bootstrapProjectId: import("effect/Schema").optional<
                  import("effect/Schema").brand<import("effect/Schema").Trim, "ProjectId">
                >;
                readonly bootstrapThreadId: import("effect/Schema").optional<
                  import("effect/Schema").brand<import("effect/Schema").Trim, "ThreadId">
                >;
              }>;
            }>,
  ...
  | import("effect/unstable/rpc/Rpc").Rpc<
      ...
      import("effect/Schema").Struct<{
        ...
        readonly projects: import("effect/Schema").$Array<
          import("effect/Schema").Struct<{
        ...
        >;
        readonly threads: import("effect/Schema").$Array<
          import("effect/Schema").Struct<{
            ...
            readonly branch: import("effect/Schema").NullOr<import("effect/Schema").Trim>;
            readonly worktreePath: import("effect/Schema").NullOr<import("effect/Schema").Trim>;
            readonly latestTurn: import("effect/Schema").NullOr<
              import("effect/Schema").Struct<{
                readonly turnId: import("effect/Schema").brand<
                  import("effect/Schema").Trim,
                  "TurnId"
                >;
                readonly state: import("effect/Schema").Literals<
                  readonly ["running", "interrupted", "completed", "error"]
                >;
                ...
                readonly completedAt: import("effect/Schema").NullOr<
                  import("effect/Schema").String
                >;
                readonly assistantMessageId: import("effect/Schema").NullOr<
                  import("effect/Schema").brand<import("effect/Schema").Trim, "MessageId">
            ...
            readonly createdAt: import("effect/Schema").String;
            readonly updatedAt: import("effect/Schema").String;
            readonly archivedAt: import("effect/Schema").withDecodingDefault<
              import("effect/Schema").NullOr<import("effect/Schema").String>
            >;
            readonly deletedAt: import("effect/Schema").NullOr<import("effect/Schema").String>;
            readonly messages: import("effect/Schema").$Array<
              import("effect/Schema").Struct<{
                readonly id: import("effect/Schema").brand<
                  import("effect/Schema").Trim,
                  "MessageId"
            ...
            >;
            readonly proposedPlans: import("effect/Schema").withDecodingDefault<
              import("effect/Schema").$Array<
                import("effect/Schema").Struct<{
                  readonly id: import("effect/Schema").Trim;
                  readonly turnId: import("effect/Schema").NullOr<
              ...
              >
            >;
            readonly activities: import("effect/Schema").$Array<
              import("effect/Schema").Struct<{
            ...
            >;
            readonly checkpoints: import("effect/Schema").$Array<
              import("effect/Schema").Struct<{
                readonly turnId: import("effect/Schema").brand<
                  import("effect/Schema").Trim,
                  "TurnId"
            ...
            >;
            readonly session: import("effect/Schema").NullOr<
              import("effect/Schema").Struct<{
                readonly threadId: import("effect/Schema").brand<
                  import("effect/Schema").Trim,
                  "ThreadId"
      ...
      typeof import("@t3tools/contracts").OrchestrationGetSnapshotError,
      never,
      never
    >
  | import("effect/unstable/rpc/Rpc").Rpc<
      ...
      import("effect/Schema").Union<
        readonly [
          import("effect/Schema").Struct<{
            ...
            readonly commandId: import("effect/Schema").brand<
              import("effect/Schema").Trim,
              "CommandId"
            >;
            readonly projectId: import("effect/Schema").brand<
          ...
          import("effect/Schema").Struct<{
            ...
            readonly threadId: import("effect/Schema").brand<
              ...
              "ThreadId"
            >;
            readonly interactionMode: import("effect/Schema").Literals<
          ...
          import("effect/Schema").Struct<{
            ...
            readonly message: import("effect/Schema").Struct<{
              ...
              readonly text: import("effect/Schema").String;
              readonly attachments: import("effect/Schema").$Array<
                import("effect/Schema").Union<
                  readonly [
                    import("effect/Schema").Struct<{
                      readonly type: import("effect/Schema").Literal<"image">;
            ...
            readonly interactionMode: import("effect/Schema").Literals<
              readonly ["default", "plan"]
            >;
            readonly bootstrap: import("effect/Schema").optional<
              import("effect/Schema").Struct<{
                readonly createThread: import("effect/Schema").optional<
                  import("effect/Schema").Struct<{
                    readonly projectId: import("effect/Schema").brand<
                      import("effect/Schema").Trim,
                      "ProjectId"
                    ...
                    >;
                    readonly branch: import("effect/Schema").NullOr<import("effect/Schema").Trim>;
                    readonly worktreePath: import("effect/Schema").NullOr<
                      import("effect/Schema").Trim
                    >;
                    readonly createdAt: import("effect/Schema").String;
                  }>
                >;
                readonly prepareWorktree: import("effect/Schema").optional<
                  import("effect/Schema").Struct<{
                ...
                >;
                readonly runSetupScript: import("effect/Schema").optional<
                  import("effect/Schema").Boolean
                >;
              }>
            >;
      ...
      typeof import("@t3tools/contracts").OrchestrationDispatchCommandError,
      never,
      never
    >
  | import("effect/unstable/rpc/Rpc").Rpc<
      ...
      typeof import("@t3tools/contracts").OrchestrationGetTurnDiffError,
      never,
      never
    >
  | import("effect/unstable/rpc/Rpc").Rpc<
      ...
      typeof import("@t3tools/contracts").OrchestrationGetFullThreadDiffError,
      never,
      never
    >
  | import("effect/unstable/rpc/Rpc").Rpc<
      ...
      import("effect/Schema").$Array<
        ...
        >
      >,
      typeof import("@t3tools/contracts").OrchestrationReplayEventsError,
      never,
      never
    >
>;
export declare class WsRpcAtomClient extends WsRpcAtomClient_base {}
export declare function runRpc<TSuccess, TError = never>(
