...
export declare const makeWsRpcProtocolClient: Effect.Effect<{
    ...
    readonly "server.getConfig": <const AsQueue extends boolean = false, const Discard = false>(input: {}, options?: {
        ...
        readonly availableEditors: readonly ("cursor" | "trae" | "kiro" | "vscode" | "vscode-insiders" | "vscodium" | "zed" | "antigravity" | "idea" | "file-manager")[];
    ...
    }, import("effect/unstable/rpc/RpcClientError").RpcClientError | (Discard extends true ? never : import("@t3tools/contracts").ServerSettingsError | import("@t3tools/contracts").KeybindingsConfigError), never>;
    ...
    readonly "shell.openInEditor": <const AsQueue extends boolean = false, const Discard = false>(input: {
        readonly cwd: string;
        readonly editor: "cursor" | "trae" | "kiro" | "vscode" | "vscode-insiders" | "vscodium" | "zed" | "antigravity" | "idea" | "file-manager";
    }, options?: {
        readonly headers?: import("effect/unstable/http/Headers").Input | undefined;
        readonly context?: import("effect/Context").Context<never> | undefined;
        readonly discard?: Discard | undefined;
    ...
    readonly "filesystem.browse": <const AsQueue extends boolean = false, const Discard = false>(input: {
    ...
    }, import("effect/unstable/rpc/RpcClientError").RpcClientError | (Discard extends true ? never : import("@t3tools/contracts").FilesystemBrowseError), never>;
    ...
    readonly "orchestration.replayEvents": <const AsQueue extends boolean = false, const Discard = false>(input: {
        ...
        readonly payload: {
            readonly threadId: string & import("effect/Brand").Brand<"ThreadId">;
            readonly session: {
                readonly status: "ready" | "error" | "idle" | "starting" | "running" | "interrupted" | "stopped";
                readonly updatedAt: string;
                readonly threadId: string & import("effect/Brand").Brand<"ThreadId">;
    ...
    }, import("@t3tools/contracts").OrchestrationGetSnapshotError | import("effect/unstable/rpc/RpcClientError").RpcClientError | import("effect/Cause").Done<void>>, never, import("effect/Scope").Scope> : import("effect/Stream").Stream<{
        readonly kind: "project-upserted";
        readonly sequence: number;
        readonly project: {
            readonly id: string & import("effect/Brand").Brand<"ProjectId">;
    ...
    }, import("@t3tools/contracts").OrchestrationGetSnapshotError | import("effect/unstable/rpc/RpcClientError").RpcClientError, never>;
    ...
    }, import("@t3tools/contracts").ServerSettingsError | import("@t3tools/contracts").KeybindingsConfigError | import("effect/unstable/rpc/RpcClientError").RpcClientError | import("effect/Cause").Done<void>>, never, import("effect/Scope").Scope> : import("effect/Stream").Stream<{
        readonly type: "snapshot";
        readonly version: 1;
        readonly config: {
            readonly auth: {
    ...
    }, import("@t3tools/contracts").ServerSettingsError | import("@t3tools/contracts").KeybindingsConfigError | import("effect/unstable/rpc/RpcClientError").RpcClientError, never>;
    ...
    readonly subscribeAuthAccess: <const AsQueue extends boolean = false, const Discard = false>(input: {}, options?: {
        readonly asQueue?: AsQueue | undefined;
        readonly streamBufferSize?: number | undefined;
        readonly headers?: import("effect/unstable/http/Headers").Input | undefined;
        readonly context?: import("effect/Context").Context<never> | undefined;
...
}, never, import("effect/Scope").Scope | RpcClient.Protocol>;
...
export declare function createWsRpcProtocolLayer(url: WsRpcProtocolSocketUrlProvider, handlers?: WsProtocolLifecycleHandlers): Layer.Layer<RpcClient.Protocol, never, never>;
export {};
