      ...
      ? Effect.Effect<
          import("effect/Queue").Dequeue<
            ...
            | {
                ...
                readonly result: {
                  readonly push: {
                    readonly status: "skipped_up_to_date" | "skipped_not_requested" | "pushed";
    ...
    readonly "terminal.open": <const AsQueue extends boolean = false, const Discard = false>(
      ...
      Discard extends true
        ...
        : {
            ...
            readonly threadId: string;
            readonly status: "starting" | "running" | "error" | "exited";
            readonly worktreePath: string | null;
            readonly cwd: string;
            readonly exitCode: number | null;
            readonly terminalId: string;
            ...
            | {
                ...
                readonly thread: {
                  ...
                  readonly latestTurn: {
                    ...
                    readonly state: "running" | "interrupted" | "error" | "completed";
