...
const serverApi = {
  getConfig: vi.fn(),
  subscribeConfig: vi.fn((listener) => registerListener(configListeners, listener)),
  subscribeLifecycle: vi.fn((listener) => registerListener(lifecycleListeners, listener)),
};
...
function emitServerConfigEvent(event) {
