export declare const COMPOSER_INLINE_CHIP_CLASS_NAME =
...
export declare const COMPOSER_INLINE_SKILL_CHIP_CLASS_NAME =
...
export declare const COMPOSER_INLINE_CHIP_DISMISS_BUTTON_CLASS_NAME =
