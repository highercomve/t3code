...
function normalizeComputedColor(value, fallback) {
...
function terminalThemeFromApp(mountElement) {
    ...
    children: [
      ...
      !hasTerminalSidebar &&
        _jsx("div", {
          ...
          children: _jsxs("div", {
            className:
              "pointer-events-auto inline-flex items-center overflow-hidden rounded-md border border-border/80 bg-background/70",
            children: [
              _jsx(TerminalActionButton, {
                ...
                children: _jsx(SquareSplitHorizontal, { className: "size-3.25" }),
              }),
              _jsx("div", { className: "h-4 w-px bg-border/80" }),
              _jsx(TerminalActionButton, {
                className: "p-1 text-foreground/90 transition-colors hover:bg-accent",
                onClick: onNewTerminalAction,
                label: newTerminalActionLabel,
                children: _jsx(Plus, { className: "size-3.25" }),
              }),
              _jsx("div", { className: "h-4 w-px bg-border/80" }),
              _jsx(TerminalActionButton, {
                className: "p-1 text-foreground/90 transition-colors hover:bg-accent",
                ...
                children: _jsx(Trash2, { className: "size-3.25" }),
              }),
            ],
          }),
        }),
            ...
            _jsx("div", {
              ...
              children: isSplitView
                ? _jsx("div", {
                    ...
                    children: visibleTerminalIds.map((terminalId) =>
                      _jsx(
                        "div",
                        {
                          ...
                          children: _jsx("div", {
                            ...
                            children: _jsx(TerminalViewport, {
                              threadRef: threadRef,
                              threadId: threadId,
              ...
              _jsxs("aside", {
                ...
                children: [
                  _jsx("div", {
                    ...
                    children: _jsxs("div", {
                      ...
                      children: [
                        ...
                        _jsx(TerminalActionButton, {
                          className:
                            "inline-flex h-full items-center border-l border-border/70 px-1 text-foreground/90 transition-colors hover:bg-accent/70",
                          onClick: onNewTerminalAction,
                          label: newTerminalActionLabel,
                          children: _jsx(Plus, { className: "size-3.25" }),
                        }),
                  ...
                  _jsx("div", {
                    ...
                    children: resolvedTerminalGroups.map((terminalGroup, groupIndex) => {
                      const isGroupActive =
                        terminalGroup.terminalIds.includes(resolvedActiveTerminalId);
                      ...
                      return _jsxs(
                        "div",
                        {
                          ...
                          children: [
                            ...
                            _jsx("div", {
                              className: showGroupHeaders
                                ? "ml-1 border-l border-border/60 pl-1.5"
                                : "",
                              children: terminalGroup.terminalIds.map((terminalId) => {
                                  ...
                                  "div",
                                  {
                                    ...
                                    children: [
                                      ...
                                      _jsxs("button", {
                                        ...
                                        children: [
                                          _jsx(TerminalSquare, { className: "size-3 shrink-0" }),
                                          _jsx("span", {
                                            className: "truncate",
                                            children:
                                          ...
                                          children: [
                                            _jsx(PopoverTrigger, {
                                              ...
                                              render: _jsx("button", {
                                                type: "button",
                                                className:
                                                  "inline-flex size-3.5 items-center justify-center rounded text-xs font-medium leading-none text-muted-foreground opacity-0 transition hover:bg-accent hover:text-foreground group-hover:opacity-100",
