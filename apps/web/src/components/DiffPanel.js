      ...
      _jsxs("div", {
        ...
        children: [
          canScrollTurnStripLeft &&
            _jsx("div", {
              className:
                "pointer-events-none absolute inset-y-0 left-8 z-10 w-7 bg-linear-to-r from-card to-transparent",
            }),
          canScrollTurnStripRight &&
            _jsx("div", {
              className:
                "pointer-events-none absolute inset-y-0 right-8 z-10 w-7 bg-linear-to-l from-card to-transparent",
            }),
          _jsx("button", {
            type: "button",
            className: cn(
