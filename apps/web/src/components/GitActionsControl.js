...
function GitActionItemIcon({ icon }) {
  if (icon === "commit") return _jsx(GitCommitIcon, {});
  if (icon === "push") return _jsx(CloudUploadIcon, {});
  return _jsx(GitHubIcon, {});
}
function GitQuickActionIcon({ quickAction }) {
  const iconClassName = "size-3.5";
  if (quickAction.kind === "open_pr") return _jsx(GitHubIcon, { className: iconClassName });
  if (quickAction.kind === "run_pull") return _jsx(InfoIcon, { className: iconClassName });
  if (quickAction.kind === "run_action") {
    if (quickAction.action === "commit") return _jsx(GitCommitIcon, { className: iconClassName });
    if (quickAction.action === "push" || quickAction.action === "commit_push") {
      return _jsx(CloudUploadIcon, { className: iconClassName });
    }
    return _jsx(GitHubIcon, { className: iconClassName });
  }
  if (quickAction.label === "Commit") return _jsx(GitCommitIcon, { className: iconClassName });
  return _jsx(InfoIcon, { className: iconClassName });
}
export default function GitActionsControl({ gitCwd, activeThreadRef, draftId }) {
    ...
    children: [
      !isRepo
        ? _jsx(Button, {
            ...
            children: initMutation.isPending ? "Initializing..." : "Initialize Git",
          })
        : _jsxs(Group, {
                ...
                ? _jsxs(Popover, {
                    children: [
                      _jsxs(PopoverTrigger, {
                        ...
                        children: [
                          _jsx(GitQuickActionIcon, { quickAction: quickAction }),
                          _jsx("span", {
                            className:
                      ...
                      _jsx(PopoverPopup, {
                        ...
                        side: "bottom",
                        align: "start",
                        children: quickActionDisabledReason,
                      }),
                    ],
                  })
                : _jsxs(Button, {
                  ...
                  _jsxs(MenuPopup, {
                    ...
                    children: [
                      gitActionMenuItems.map((item) => {
                              ...
                              children: [
                                _jsx(PopoverTrigger, {
                                  ...
                                  children: _jsxs(MenuItem, {
                                    ...
                                    disabled: true,
                                    children: [
                                      _jsx(GitActionItemIcon, { icon: item.icon }),
                                      item.label,
                                    ],
                                  }),
                                }),
                        ...
                        return _jsxs(
                          MenuItem,
                          {
                            ...
                            children: [_jsx(GitActionItemIcon, { icon: item.icon }), item.label],
                          },
                          `${item.id}-${item.label}`,
                        );
                      }),
                      gitStatusForActions?.branch === null &&
                        _jsx("p", {
                          className: "px-2 py-1.5 text-xs text-warning",
                          children:
                      ...
                      gitStatusForActions &&
                        ...
                        _jsx("p", {
                          className: "px-2 py-1.5 text-xs text-warning",
                          children: "Behind upstream. Pull/rebase first.",
                        }),
                      gitStatusError &&
                        _jsx("p", {
                          className: "px-2 py-1.5 text-xs text-destructive",
                          children: gitStatusError.message,
                        }),
                    ],
                  }),
                ],
      ...
      _jsx(Dialog, {
        ...
        children: _jsxs(DialogPopup, {
          children: [
            _jsxs(DialogHeader, {
              children: [
                _jsx(DialogTitle, { children: COMMIT_DIALOG_TITLE }),
                _jsx(DialogDescription, { children: COMMIT_DIALOG_DESCRIPTION }),
              ],
            }),
            _jsxs(DialogPanel, {
              className: "space-y-4",
              children: [
                _jsxs("div", {
                  ...
                  children: [
                    _jsxs("div", {
                      className: "grid grid-cols-[auto_1fr] items-center gap-x-2 gap-y-1",
                      children: [
                        _jsx("span", { className: "text-muted-foreground", children: "Branch" }),
                        _jsxs("span", {
                          className: "flex items-center justify-between gap-2",
                          children: [
                            _jsx("span", {
                              className: "font-medium",
                              children: gitStatusForActions?.branch ?? "(detached HEAD)",
                            }),
                            isDefaultBranch &&
                              _jsx("span", {
                                className: "text-right text-warning text-xs",
                                children: "Warning: default branch",
                              }),
                          ],
                        }),
                      ],
                          ...
                          children: [
                            ...
                            allFiles.length > 0 &&
                              _jsx(Button, {
                                ...
                                children: isEditingFiles ? "Done" : "Edit",
                              }),
                          ],
                        }),
                        !gitStatusForActions || allFiles.length === 0
                          ? _jsx("p", { className: "font-medium", children: "none" })
                          : _jsxs("div", {
                              className: "space-y-2",
                              children: [
                                _jsx(ScrollArea, {
                                  className: "h-44 rounded-md border border-input bg-background",
                                  children: _jsx("div", {
                                    ...
                                    children: allFiles.map((file) => {
                                      ...
                                      return _jsxs(
                                        ...
                                        {
                                          className:
                                            "flex w-full items-center gap-2 rounded-md px-2 py-1 font-mono text-xs transition-colors hover:bg-accent/50",
                                          children: [
                                            isEditingFiles &&
                                              _jsx(Checkbox, {
                                            ...
                                            _jsxs("button", {
                                              type: "button",
                                              className:
                                                "flex flex-1 items-center justify-between gap-3 text-left truncate",
          ...
          children: [
            _jsxs(DialogHeader, {
              children: [
                ...
                _jsx(DialogDescription, { children: pendingDefaultBranchActionCopy?.description }),
              ],
            }),
            _jsxs(DialogFooter, {
              children: [
                ...
                _jsx(Button, {
                  ...
                  children: pendingDefaultBranchActionCopy?.continueLabel ?? "Continue",
                }),
                _jsx(Button, {
                  size: "sm",
