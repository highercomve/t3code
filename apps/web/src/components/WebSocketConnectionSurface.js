    ...
    children: [
      _jsxs("div", {
        ...
        children: [
          _jsx("div", {
            className:
              "absolute inset-x-0 top-0 h-56 bg-[radial-gradient(48rem_18rem_at_top,color-mix(in_srgb,var(--color-amber-500)_16%,transparent),transparent)]",
          }),
          _jsx("div", {
            className:
              "absolute inset-0 bg-[linear-gradient(145deg,color-mix(in_srgb,var(--background)_92%,var(--color-black))_0%,var(--background)_56%)]",
          }),
        ],
      }),
      _jsxs("section", {
        className:
          "relative w-full max-w-xl rounded-[1.75rem] border border-border/80 bg-card/92 p-6 shadow-2xl shadow-black/20 backdrop-blur-md sm:p-8",
        children: [
          _jsxs("div", {
            ...
            children: [
              ...
              _jsx("div", {
                className:
                  "rounded-2xl border border-border/70 bg-background/80 p-3 text-foreground shadow-sm",
                children: _jsx(Icon, {
                  className: uiState === "connecting" ? "size-5 animate-spin" : "size-5",
                }),
              }),
            ],
          }),
          ...
          _jsxs("div", {
            className:
              "mt-5 grid gap-3 rounded-2xl border border-border/70 bg-background/60 p-4 text-sm sm:grid-cols-2",
            children: [
              _jsxs("div", {
                children: [
                  _jsx("p", {
              ...
              _jsxs("div", {
                children: [
                  ...
                  _jsx("p", {
                    className: "mt-1 font-medium text-foreground",
                    children: disconnectedAt ?? "Pending",
                  }),
                ],
              }),
            ],
          ...
          _jsx("div", {
            ...
            children: _jsxs(Button, {
              ...
              children: [_jsx(RotateCw, {}), "Reload app"],
            }),
          }),
          _jsxs("details", {
            className:
              ...
              _jsxs("summary", {
                ...
                children: [
                  _jsx("span", {
                    ...
                    children: "Show connection details",
                  }),
                  _jsx("span", {
                    className: "hidden group-open:inline",
                    children: "Hide connection details",
                  }),
                ],
              }),
              _jsx("pre", {
                ...
                children: buildConnectionDetails(status, uiState),
              }),
            ],
          }),
        ],
...
export function WebSocketConnectionSurface({ children }) {
  ...
  if (serverConfig === null) {
    const uiState = getWsConnectionUiState(status);
    return _jsx(WebSocketBlockingState, {
      status: status,
