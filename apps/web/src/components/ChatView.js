...
const threadPlanCatalogCache = new LRUCache(
  MAX_THREAD_PLAN_CATALOG_CACHE_ENTRIES,
  MAX_THREAD_PLAN_CATALOG_CACHE_MEMORY_BYTES,
);
...
function PersistentThreadTerminalDrawer({
  ...
  return _jsx("div", {
    ...
    children: _jsx(ThreadTerminalDrawer, {
      threadId: threadId,
      cwd: cwd,
      worktreePath: effectiveWorktreePath,
...
export default function ChatView({ threadId }) {
  ...
  const openTerminalThreadIds = useMemo(
    () =>
      Object.entries(terminalStateByThreadId).flatMap(([nextThreadId, nextTerminalState]) =>
        nextTerminalState.terminalOpen ? [nextThreadId] : [],
      ),
  ...
  const draftThreadIds = useMemo(
    () => Object.keys(draftThreadsByThreadId),
  ...
  const onChangeActivePendingUserInputCustomAnswer = useCallback(
    (questionId, value, nextCursor, expandedCursor, cursorAdjacentToMention) => {
      if (!activePendingUserInput) {
        return;
      }
  ...
  const onSubmitPlanFollowUp = useCallback(
    async ({ text, interactionMode: nextInteractionMode }) => {
      const api = readNativeApi();
      if (
        !api ||
        !activeThread ||
  ...
  return _jsxs("div", {
    ...
    children: [
      ...
      _jsx(ProviderStatusBanner, { status: activeProviderStatus }),
                  ...
                  showScrollToBottom &&
                    _jsx("div", {
                      ...
                      children: _jsxs("button", {
                        ...
                        className:
                          "pointer-events-auto flex items-center gap-1.5 rounded-full border border-border/60 bg-card px-3 py-1 text-muted-foreground text-xs shadow-sm transition-colors hover:border-border hover:text-foreground hover:cursor-pointer",
                        children: [
                          _jsx(ChevronDownIcon, { className: "size-3.5" }),
                          "Scroll to bottom",
                        ],
                      }),
                    }),
                      ...
                      children: [
                                          ...
                                          _jsxs(Tooltip, {
                                            children: [
                                              ...
                                              _jsx(TooltipPopup, {
                                                side: "top",
                                                className:
                                                  "max-w-64 whitespace-normal leading-tight",
                                                children:
                        ...
                        activePendingApproval
                          ...
                          : _jsxs("div", {
                              ...
                              "data-chat-composer-footer-compact": isComposerFooterCompact
                                ? "true"
                                : "false",
                              className: cn(
                              ...
                              children: [
                                ...
                                _jsxs("div", {
                                  ...
                                  children: [
                                    activeContextWindow
                                      ? _jsx(ContextWindowMeter, { usage: activeContextWindow })
                                      : null,
                                    isPreparingWorktree
                                      ? _jsx("span", {
                                    ...
                                    _jsx(ComposerPrimaryActions, {
                                      ...
                                      pendingAction: activePendingProgress
                                        ? {
