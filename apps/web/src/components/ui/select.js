...
function SelectButton({ className, size, variant, render, children, ...props }) {
  ...
  const defaultProps = {
    children: _jsxs(_Fragment, {
      children: [
        ...
        variant === "ghost"
          ? _jsx(ChevronDownIcon, { className: "size-3 opacity-50" })
          : _jsx(ChevronsUpDownIcon, { className: selectTriggerIconClassName }),
      ],
    }),
...
function SelectTrigger({ className, size = "default", variant = "default", children, ...props }) {
  return _jsxs(SelectPrimitive.Trigger, {
    ...
    children: [
      ...
      _jsx(SelectPrimitive.Icon, {
        ...
        children: _jsx(ChevronDownIcon, { className: "size-3 opacity-50" }),
      }),
    ],
  });
}
  ...
  return _jsx(SelectPrimitive.Portal, {
    children: _jsx(SelectPrimitive.Positioner, {
      ...
      children: _jsxs(SelectPrimitive.Popup, {
        ...
        ...props,
        children: [
          _jsx(SelectPrimitive.ScrollUpArrow, {
            className:
            ...
            children: _jsx(ChevronUpIcon, { className: "relative size-4.5 sm:size-4" }),
          }),
          _jsx("div", {
            className:
          ...
          _jsx(SelectPrimitive.ScrollDownArrow, {
            className:
            ...
            children: _jsx(ChevronDownIcon, { className: "relative size-4.5 sm:size-4" }),
          }),
        ],
      }),
    }),
