...
function AlertDialogBackdrop({ className, ...props }) {
  return _jsx(AlertDialogPrimitive.Backdrop, {
    className: cn(
...
function AlertDialogViewport({ className, ...props }) {
  return _jsx(AlertDialogPrimitive.Viewport, {
    className: cn(
...
function AlertDialogPopup({ className, bottomStickOnMobile = true, ...props }) {
  return _jsxs(AlertDialogPortal, {
    children: [
      _jsx(AlertDialogBackdrop, {}),
      _jsx(AlertDialogViewport, {
        className: cn(bottomStickOnMobile && "max-sm:grid-rows-[1fr_auto] max-sm:p-0 max-sm:pt-12"),
        children: _jsx(AlertDialogPrimitive.Popup, {
          className: cn(
