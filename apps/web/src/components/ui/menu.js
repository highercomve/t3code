...
function MenuTrigger({ className, children, ...props }) {
  return _jsx(MenuPrimitive.Trigger, {
    className: className,
...
function MenuGroup(props) {
  return _jsx(MenuPrimitive.Group, { "data-slot": "menu-group", ...props });
}
...
function MenuCheckboxItem({ className, children, checked, variant = "default", ...props }) {
  return _jsx(MenuPrimitive.CheckboxItem, {
    checked: checked,
    className: cn(
    ...
    children:
      variant === "switch"
        ? _jsxs(_Fragment, {
            children: [
              _jsx("span", { className: "col-start-1", children: children }),
              _jsx(MenuPrimitive.CheckboxItemIndicator, {
                className:
                  "inset-shadow-[0_1px_--theme(--color-black/4%)] inline-flex h-[calc(var(--thumb-size)+2px)] w-[calc(var(--thumb-size)*2-2px)] shrink-0 items-center rounded-full p-px outline-none transition-[background-color,box-shadow] duration-200 [--thumb-size:--spacing(4)] focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-1 focus-visible:ring-offset-background data-checked:bg-primary data-unchecked:bg-input data-disabled:opacity-64 sm:[--thumb-size:--spacing(3)]",
                keepMounted: true,
                children: _jsx("span", {
                  className:
            ...
            children: [
              _jsx(MenuPrimitive.CheckboxItemIndicator, {
                ...
                children: _jsx("svg", {
                  ...
                  children: _jsx("path", { d: "M5.252 12.7 10.2 18.63 18.748 5.37" }),
                }),
              }),
              _jsx("span", { className: "col-start-2", children: children }),
            ],
          }),
  });
}
function MenuRadioGroup(props) {
  return _jsx(MenuPrimitive.RadioGroup, { "data-slot": "menu-radio-group", ...props });
}
function MenuRadioItem({ className, children, ...props }) {
  return _jsxs(MenuPrimitive.RadioItem, {
    ...
    ...props,
    children: [
      _jsx(MenuPrimitive.RadioItemIndicator, {
        className: "col-start-1",
        children: _jsx("svg", {
          fill: "none",
          height: "24",
...
function MenuSub(props) {
  return _jsx(MenuPrimitive.SubmenuRoot, { "data-slot": "menu-sub", ...props });
}
function MenuSubTrigger({ className, inset, children, ...props }) {
  return _jsxs(MenuPrimitive.SubmenuTrigger, {
    ...
    ...props,
    children: [children, _jsx(ChevronRightIcon, { className: "-me-0.5 ms-auto opacity-80" })],
  });
}
function MenuSubPopup({ className, sideOffset = 0, alignOffset, align = "start", ...props }) {
  const defaultAlignOffset = align !== "center" ? -5 : undefined;
  return _jsx(MenuPopup, {
    align: align,
