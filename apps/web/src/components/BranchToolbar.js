      ...
      envLocked || activeWorktreePath
        ? _jsx("span", {
            ...
            children: activeWorktreePath
              ? _jsxs(_Fragment, {
                  children: [_jsx(GitForkIcon, { className: "size-3" }), "Worktree"],
                })
              : _jsxs(_Fragment, {
                  children: [_jsx(FolderIcon, { className: "size-3" }), "Local"],
                }),
          })
        : _jsxs(Select, {
              ...
              _jsxs(SelectTrigger, {
                ...
                children: [
                  effectiveEnvMode === "worktree"
                    ? _jsx(GitForkIcon, { className: "size-3" })
              ...
              _jsxs(SelectPopup, {
                children: [
                  ...
                  _jsx(SelectItem, {
                    ...
                    children: _jsxs("span", {
                      className: "inline-flex items-center gap-1.5",
                      children: [_jsx(GitForkIcon, { className: "size-3" }), "New worktree"],
                    }),
                  }),
                ],
              }),
