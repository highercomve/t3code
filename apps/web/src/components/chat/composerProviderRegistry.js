...
import { getProviderModelCapabilities, normalizeClaudeModelOptionsWithCapabilities, normalizeCodexModelOptionsWithCapabilities, normalizeGeminiModelOptionsWithCapabilities, normalizeOpencodeModelOptionsWithCapabilities, } from "../../providerModels";
...
function makeCapabilitiesRegistryEntry(provider) {
    return {
        ...
        renderTraitsMenuContent: ({ threadId, model, models, modelOptions, prompt, onPromptChange, }) => (_jsx(TraitsMenuContent, { provider: provider, models: models, threadId: threadId, model: model, modelOptions: modelOptions, prompt: prompt, onPromptChange: onPromptChange })),
        renderTraitsPicker: ({ threadId, model, models, modelOptions, prompt, onPromptChange }) => (_jsx(TraitsPicker, { provider: provider, models: models, threadId: threadId, model: model, modelOptions: modelOptions, prompt: prompt, onPromptChange: onPromptChange })),
    };
}
