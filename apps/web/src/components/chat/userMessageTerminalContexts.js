...
export function buildInlineTerminalContextText(contexts) {
  return contexts
...
export function formatInlineTerminalContextLabel(header) {
...
export function textContainsInlineTerminalContextLabels(text, contexts) {
