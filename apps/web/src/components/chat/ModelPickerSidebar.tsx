...
export const ModelPickerSidebar = memo(function ModelPickerSidebar(props: {
  ...
  /**
   * @deprecated Coming-soon provider placeholders are obsolete now that
   * Antigravity and Copilot ship as first-class providers. Kept on the prop
   * surface so existing callers don't break; the value is ignored.
   */
