      ...
      _jsx(MenuTrigger, {
        ...
        children: _jsxs("span", {
          ...
          children: [
            ...
            _jsx("span", { className: "min-w-0 flex-1 truncate", children: selectedModelLabel }),
      ...
      _jsx(MenuPopup, {
        ...
        children:
          props.lockedProvider !== null
            ? _jsx(MenuGroup, {
                children: _jsx(MenuRadioGroup, {
                  value: props.model,
                  onValueChange: (value) => handleModelChange(props.lockedProvider, value),
                  children: props.modelOptionsByProvider[props.lockedProvider].map((modelOption) =>
                    _jsx(
                      MenuRadioItem,
                      {
                      ...
                      `${props.lockedProvider}:${modelOption.slug}`,
                    ),
                  ),
                }),
              })
            : _jsxs(_Fragment, {
                children: [
                      ...
                      return _jsxs(
                        MenuItem,
                        {
                          ...
                          children: [
                            ...
                            _jsx("span", {
                              className:
                                "ms-auto text-[11px] text-muted-foreground/80 uppercase tracking-[0.08em]",
                          ...
                          _jsx(MenuSubPopup, {
                            ...
                            children: _jsx(MenuGroup, {
                              children: _jsx(MenuRadioGroup, {
                                ...
                                children: props.modelOptionsByProvider[option.value].map(
                                  (modelOption) =>
                                    _jsx(
                                      MenuRadioItem,
                                      {
                  ...
                  UNAVAILABLE_PROVIDER_OPTIONS.length > 0 && _jsx(MenuDivider, {}),
