...
function getSelectedTraits(
  ...
  const thinkingEnabled = caps.supportsThinkingToggle ? (modelOptions?.thinking ?? true) : null;
  // Fast mode
...
export const TraitsMenuContent = memo(function TraitsMenuContentImpl({
  ...
  return _jsxs(_Fragment, {
    children: [
      effort
        ? _jsx(_Fragment, {
            children: _jsxs(MenuGroup, {
              children: [
                _jsx("div", {
                  className: "px-2 pt-1.5 pb-1 font-medium text-muted-foreground text-xs",
                  children: "Effort",
                }),
                ultrathinkPromptControlled
                  ? _jsx("div", {
                      className: "px-2 pb-1.5 text-muted-foreground/80 text-xs",
                      children: "Remove Ultrathink from the prompt to change effort.",
                    })
                  : null,
                _jsx(MenuRadioGroup, {
                  value: effort,
                  onValueChange: handleEffortChange,
                  children: effortLevels.map((option) =>
                    _jsxs(
                      MenuRadioItem,
                      {
                        value: option.value,
          ...
          ? _jsxs(MenuGroup, {
              children: [
                ...
                _jsxs(MenuRadioGroup, {
                  ...
                  children: [
                    _jsx(MenuRadioItem, { value: "on", children: "On (default)" }),
                    _jsx(MenuRadioItem, { value: "off", children: "Off" }),
                  ],
                }),
              ],
            })
              ...
              _jsxs(MenuGroup, {
                children: [
                  ...
                  _jsxs(MenuRadioGroup, {
                    ...
                    children: [
                      _jsx(MenuRadioItem, { value: "off", children: "off" }),
                      _jsx(MenuRadioItem, { value: "on", children: "on" }),
                    ],
                  }),
                ],
              }),
              ...
              _jsxs(MenuGroup, {
                children: [
                  ...
                  _jsx(MenuRadioGroup, {
                    ...
                    children: contextWindowOptions.map((option) =>
                      _jsxs(
                        MenuRadioItem,
                        {
                          value: option.value,
    ...
    children: [
      _jsx(MenuTrigger, {
        ...
        children: isCodexStyle
          ...
          : _jsxs(_Fragment, {
              children: [
                _jsx("span", { children: triggerLabel }),
                _jsx(ChevronDownIcon, { "aria-hidden": "true", className: "size-3 opacity-60" }),
              ],
            }),
      }),
      _jsx(MenuPopup, {
        align: "start",
        children: _jsx(TraitsMenuContent, {
          provider: provider,
          models: models,
          model: model,
          prompt: prompt,
