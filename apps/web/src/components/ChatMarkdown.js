...
const highlightedCodeCache = new LRUCache(
  ...
  return _jsxs("div", {
    ...
    children: [
      _jsx("button", {
        ...
        children: copied
          ? _jsx(CheckIcon, { className: "size-3" })
...
function ChatMarkdown({ text, cwd, isStreaming = false }) {
  ...
  const markdownUrlTransform = useCallback((href) => {
  ...
  const markdownComponents = useMemo(
    () => ({
      ...
      pre({ node: _node, children, ...props }) {
        ...
        return _jsx(MarkdownCodeBlock, {
          code: codeBlock.code,
          children: _jsx(CodeHighlightErrorBoundary, {
            fallback: _jsx("pre", { ...props, children: children }),
            children: _jsx(Suspense, {
              fallback: _jsx("pre", { ...props, children: children }),
              children: _jsx(SuspenseShikiCodeBlock, {
