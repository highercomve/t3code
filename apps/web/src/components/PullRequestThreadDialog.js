...
export function PullRequestThreadDialog({
  ...
  const cachedPullRequest = useMemo(() => {
    ...
    const cached = queryClient.getQueryData(["git", "pull-request", cwd, parsedReference]);
  ...
  return _jsx(Dialog, {
    ...
    children: _jsxs(DialogPopup, {
      ...
      children: [
        _jsxs(DialogHeader, {
          children: [
            _jsx(DialogTitle, { children: "Checkout Pull Request" }),
        ...
        _jsxs(DialogPanel, {
          ...
          children: [
            ...
            resolvedPullRequest
              ? _jsx("div", {
                  className: "rounded-xl border border-border/70 bg-muted/24 p-3",
                  children: _jsxs("div", {
                    ...
                    children: [
                      _jsxs("div", {
                        ...
                        children: [
                          _jsx("p", {
                            ...
                            children: resolvedPullRequest.title,
                          }),
                          _jsxs("p", {
                      ...
                      _jsx("span", {
                        className: cn("shrink-0 text-xs capitalize", statusTone),
                        children: resolvedPullRequest.state,
                      }),
                    ],
                  }),
                })
            ...
            isResolving
              ? _jsxs("div", {
                  ...
                  children: [_jsx(Spinner, { className: "size-3.5" }), "Resolving pull request..."],
                })
              : null,
            errorMessage
              ? _jsx("p", { className: "text-destructive text-xs", children: errorMessage })
              : null,
          ],
        }),
        _jsxs(DialogFooter, {
          children: [
            ...
            _jsx(Button, {
              ...
              children: preparingMode === "local" ? "Preparing local..." : "Local",
            }),
            _jsx(Button, {
              type: "button",
              size: "sm",
              ...
              disabled:
                ...
                isResolving ||
                preparePullRequestThreadMutation.isPending,
              children: preparingMode === "worktree" ? "Preparing worktree..." : "Worktree",
            }),
          ],
        }),
      ],
