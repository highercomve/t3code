...
export function BranchToolbarBranchSelector({
  ...
  const [resolvedActiveBranch, setOptimisticBranch] = useOptimistic(
    ...
    (_currentBranch, optimisticBranch) => optimisticBranch,
  );
  ...
  function renderPickerItem(itemValue, index) {
    if (checkoutPullRequestItemValue && itemValue === checkoutPullRequestItemValue) {
      return _jsx(
        ComboboxItem,
        {
          ...
          children: _jsxs("div", {
            className: "flex min-w-0 flex-col items-start py-1",
            children: [
              _jsx("span", {
                className: "truncate font-medium",
                children: "Checkout Pull Request",
              }),
              _jsx("span", {
                className: "truncate text-muted-foreground text-xs",
                children: prReference,
              }),
            ],
          }),
        },
    ...
    if (createBranchItemValue && itemValue === createBranchItemValue) {
      return _jsx(
        ComboboxItem,
        {
          ...
          children: _jsxs("span", {
            className: "truncate",
            children: ['Create new branch "', trimmedBranchQuery, '"'],
          }),
        },
        itemValue,
      );
    ...
    return _jsx(
      ComboboxItem,
      {
        ...
        children: _jsxs("div", {
          ...
          children: [
            _jsx("span", { className: "truncate", children: itemValue }),
            badge &&
              _jsx("span", {
  ...
  return _jsxs(Combobox, {
    ...
    children: [
      _jsxs(ComboboxTrigger, {
        render: _jsx(Button, { variant: "ghost", size: "xs" }),
        className: "text-muted-foreground/70 hover:text-foreground/80",
        disabled: (isBranchesSearchPending && branches.length === 0) || isBranchActionPending,
        children: [
          _jsx("span", { className: "max-w-[240px] truncate", children: triggerLabel }),
      ...
      _jsxs(ComboboxPopup, {
        ...
        children: [
          ...
          _jsx(ComboboxEmpty, { children: "No branches found." }),
          shouldVirtualizeBranchList
            ? _jsx(ComboboxListVirtualized, {
            ...
            : _jsx(ComboboxList, {
                ...
                className: "max-h-56",
                children: filteredBranchPickerItems.map((itemValue, index) =>
                  renderPickerItem(itemValue, index),
                ),
              }),
          branchStatusText ? _jsx(ComboboxStatus, { children: branchStatusText }) : null,
        ],
      }),
    ],
  });
