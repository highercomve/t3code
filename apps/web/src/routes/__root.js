    ...
    return _jsx("div", {
      ...
      children: _jsx("div", {
        ...
        children: _jsxs("p", {
          ...
          children: ["Connecting to ", APP_DISPLAY_NAME, " server..."],
        }),
      }),
    });
  }
  return _jsx(ToastProvider, {
    children: _jsxs(AnchoredToastProvider, {
      children: [
        _jsx(ServerStateBootstrap, {}),
        _jsx(EventRouter, {}),
        _jsx(WebSocketConnectionCoordinator, {}),
        _jsx(SlowRpcAckToastCoordinator, {}),
        _jsx(WebSocketConnectionSurface, {
          children: _jsx(AppSidebarLayout, { children: _jsx(Outlet, {}) }),
        }),
      ],
    }),
  });
      ...
      _jsxs("section", {
        ...
        children: [
          ...
          _jsxs("div", {
            ...
            children: [
              _jsx(Button, { size: "sm", onClick: () => reset(), children: "Try again" }),
              _jsx(Button, {
                size: "sm",
                variant: "outline",
          ...
          _jsxs("details", {
            className:
              "group mt-5 overflow-hidden rounded-lg border border-border/70 bg-background/55",
            children: [
              _jsxs("summary", {
                className:
                  "cursor-pointer list-none px-3 py-2 text-xs font-medium text-muted-foreground",
                children: [
                  _jsx("span", { className: "group-open:hidden", children: "Show error details" }),
                  _jsx("span", {
                    className: "hidden group-open:inline",
                    children: "Hide error details",
                  }),
                ],
              }),
              _jsx("pre", {
                className:
                  "max-h-56 overflow-auto border-t border-border/70 bg-background/80 px-3 py-2 text-xs text-foreground/85",
                children: details,
              }),
            ],
          }),
