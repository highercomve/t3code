...
const THREAD_REF = scopeThreadRef("environment-a", THREAD_ID);
const OTHER_THREAD_REF = scopeThreadRef("environment-b", THREAD_ID);
function makeTerminalEvent(type, overrides = {}) {
  const base = {
    threadId: THREAD_ID,
    terminalId: "default",
  ...
  switch (type) {
    ...
    case "activity":
      return { ...base, type, hasRunningSubprocess: true, ...overrides };
    case "error":
      return { ...base, type, message: "boom", ...overrides };
    case "cleared":
      return { ...base, type, ...overrides };
    case "exited":
      return { ...base, type, exitCode: 0, exitSignal: null, ...overrides };
    case "started":
    case "restarted":
      return {
        ...base,
