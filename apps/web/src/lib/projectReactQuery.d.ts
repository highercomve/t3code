export declare const projectQueryKeys: {
    ...
    searchEntries: (cwd: string | null, query: string, limit: number) => readonly ["projects", "search-entries", string | null, string, number];
};
export declare function projectSearchEntriesQueryOptions(input: {
    ...
    readonly truncated: boolean;
}, readonly ["projects", "search-entries", string | null, string, number]>, "queryFn"> & {
    queryFn?: import("@tanstack/react-query").QueryFunction<{
        ...
        readonly truncated: boolean;
    }, readonly ["projects", "search-entries", string | null, string, number], never>;
} & {
