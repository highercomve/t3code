import { type EnvironmentId, type GitActionProgressEvent, type GitStackedAction, type ThreadId } from "@t3tools/contracts";
import { type QueryClient } from "@tanstack/react-query";
export declare const gitQueryKeys: {
    all: readonly ["git"];
    branches: (environmentId: EnvironmentId | null, cwd: string | null) => readonly ["git", "branches", (string & import("effect/Brand").Brand<"EnvironmentId">) | null, string | null];
    branchSearch: (environmentId: EnvironmentId | null, cwd: string | null, query: string) => readonly ["git", "branches", (string & import("effect/Brand").Brand<"EnvironmentId">) | null, string | null, "search", string];
};
export declare const gitMutationKeys: {
    init: (environmentId: EnvironmentId | null, cwd: string | null) => readonly ["git", "mutation", "init", (string & import("effect/Brand").Brand<"EnvironmentId">) | null, string | null];
    checkout: (environmentId: EnvironmentId | null, cwd: string | null) => readonly ["git", "mutation", "checkout", (string & import("effect/Brand").Brand<"EnvironmentId">) | null, string | null];
    runStackedAction: (environmentId: EnvironmentId | null, cwd: string | null) => readonly ["git", "mutation", "run-stacked-action", (string & import("effect/Brand").Brand<"EnvironmentId">) | null, string | null];
    pull: (environmentId: EnvironmentId | null, cwd: string | null) => readonly ["git", "mutation", "pull", (string & import("effect/Brand").Brand<"EnvironmentId">) | null, string | null];
    preparePullRequestThread: (environmentId: EnvironmentId | null, cwd: string | null) => readonly ["git", "mutation", "prepare-pull-request-thread", (string & import("effect/Brand").Brand<"EnvironmentId">) | null, string | null];
...
export declare function gitBranchSearchInfiniteQueryOptions(input: {
    ...
    readonly nextCursor: number | null;
    readonly totalCount: number;
}, unknown>, readonly ["git", "branches", (string & import("effect/Brand").Brand<"EnvironmentId">) | null, string | null, "search", string], number>, "queryFn"> & {
    queryFn?: import("@tanstack/react-query").QueryFunction<{
        ...
        readonly nextCursor: number | null;
        readonly totalCount: number;
    }, readonly ["git", "branches", (string & import("effect/Brand").Brand<"EnvironmentId">) | null, string | null, "search", string], number>;
} & {
    queryKey: readonly ["git", "branches", (string & import("effect/Brand").Brand<"EnvironmentId">) | null, string | null, "search", string] & {
...
export declare function gitResolvePullRequestQueryOptions(input: {
...
}, readonly ["git", "pull-request", (string & import("effect/Brand").Brand<"EnvironmentId">) | null, string | null, string | null]>, "queryFn"> & {
    queryFn?: import("@tanstack/react-query").QueryFunction<{
        readonly pullRequest: {
            readonly number: number;
            readonly title: string;
    ...
    }, readonly ["git", "pull-request", (string & import("effect/Brand").Brand<"EnvironmentId">) | null, string | null, string | null], never>;
} & {
    queryKey: readonly ["git", "pull-request", (string & import("effect/Brand").Brand<"EnvironmentId">) | null, string | null, string | null] & {
        [dataTagSymbol]: {
            readonly pullRequest: {
                readonly number: number;
                readonly title: string;
