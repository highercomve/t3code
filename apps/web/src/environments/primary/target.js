...
function getDesktopLocalEnvironmentBootstrap() {
...
function swapBaseUrlProtocol(rawValue, nextProtocol) {
...
function resolveHttpRequestBaseUrl(httpBaseUrl) {
...
export function resolvePrimaryEnvironmentHttpUrl(pathname, searchParams) {
...
export function readPrimaryEnvironmentTarget() {
  return (
