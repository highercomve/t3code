...
const providersUpdatedListeners = new Set();
const gitActionProgressListeners = new Set();
/**
 ...
 */
export function onServerWelcome(listener) {
...
export function onServerProvidersUpdated(listener) {
