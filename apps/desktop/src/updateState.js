export function shouldBroadcastDownloadProgress(currentState, nextPercent) {
...
export function nextStatusAfterDownloadFailure(currentState) {
  return currentState.availableVersion ? "available" : "error";
}
export function getCanRetryAfterDownloadFailure(currentState) {
