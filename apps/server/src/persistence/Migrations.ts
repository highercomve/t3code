...
import Migration0027 from "./Migrations/027_CanonicalizeModelSelectionOptionsStruct.ts";
import Migration0028 from "./Migrations/028_RenameGeminiToAntigravity.ts";
...
export const migrationEntries = [
  ...
  [27, "CanonicalizeModelSelectionOptionsStruct", Migration0027],
  [28, "RenameGeminiToAntigravity", Migration0028],
] as const;
